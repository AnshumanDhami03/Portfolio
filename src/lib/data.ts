...
export const CATEGORIZED_TECH_STACK = [
    {
        ...
        skills: [
            ...
            { name: 'JavaScript', icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12,2A10,10,0,0,0,2,12a10,10,0,0,0,10,10,10,10,0,0,0,10-10A10,10,0,0,0,12,2Zm0,18a8,8,0,0,1-8-8,8,8,0,0,1,8-8,8,8,0,0,1,8,8A8,8,0,0,1,12,20Zm4-8.5a1.5,1.5,0,0,0-1.5-1.5H13V9a1,1,0,0,0-2,0v1.5H9.5a1.5,1.5,0,0,0,0,3H11V15a1,1,0,0,0,2,0V13.5h1.5a1.5,1.5,0,0,0,0-3Z"/></svg>' },
